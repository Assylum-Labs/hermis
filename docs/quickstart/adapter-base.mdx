...
```bash yarn
yarn add @hermis/solana-headless-adapter-base @solana/wallet-adapter-phantom @solana/wallet-adapter-solflare
```

```bash pnpm
pnpm add @hermis/solana-headless-adapter-base @solana/wallet-adapter-phantom @solana/wallet-adapter-solflare
```
</CodeGroup>
...
<ResponseField name="getAdaptersByReadyState" type="function">
