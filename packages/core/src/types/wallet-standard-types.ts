import { EventEmitter, WalletAdapterEvents } from "@solana/wallet-adapter-base";
...
export interface TypedStandardWallet extends Wallet {
  ...
  chains: IdentifierArray;
  version: "1.0.0";
  _connectedAccount: StandardWalletAccount[];
  _wallet: Wallet
  _rpcEndpoint: string;
  _currentCluster: string;
  _eventEmitter: EventEmitter<WalletAdapterEvents>;
  _removeAccountChangeListener: (() => void) | null;
